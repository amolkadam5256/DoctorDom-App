...
import RelatedDotors from '../components/RelatedDotors'

const Appointment = () => {

  const { docId } = useParams()
  const { doctors, currencySymbool } = useContext(AppContext)
    ...
    <>
      <div>
        ...
        <div className='flex flex-col gap-4 sm:flex-row '>
          ...
          <div className='flex-1 p-8 bg-white border border-gray-400 rounded-lg py-7 mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
            {/* Doc info name degree and exprinence  */}
            ...
            <p className='mt-4 font-medium text-gray-500'>
              Appointment fee : <span className='text-gray-600'>{currencySymbool}{docInfo.fees}</span>
            </p>
        ...
        {/* Related listing Related Doctors */}
